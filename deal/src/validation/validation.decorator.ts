...
export function MinAge(property: number, validationOptions?: ValidationOptions) {
    ...
    registerDecorator({
      ...
      validator: {
        ...
        defaultMessage: buildMessage(
          (eachPrefix) => `${eachPrefix} should be more then $constraint1 to be a valid for loan apply `,
          validationOptions,
        ),
      },
    });
