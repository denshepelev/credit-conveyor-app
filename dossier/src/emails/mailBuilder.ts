export default function mailBuilder(
  ...
  lastName: string,
  text: string,
  content: Array<string> = ['<div></div>'],
): string {
  const modifiedContent: string = content.join(' ');
  return `<!DOCTYPE html>
  <html lang="en">
  <html>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tbody><tr>
      <td style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img align="center" border="0" src="https://ih1.redbubble.net/image.3239775939.6766/st,small,507x507-pad,600x600,f8f8f8.u3.jpg" alt="Image" title="Image" style="width: 250px;  height: 250px;  background-image: url('https://d3iw72m71ie81c.cloudfront.net/female-20.jpeg');  background-size: cover;  display: block;  border-radius: 125px;  -webkit-border-radius: 125px;  -moz-border-radius: 125px;" width="168.2">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tbody><tr>
      <td style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img align="center" border="0" src="https://cdn-icons-png.flaticon.com/512/70/70009.png" alt="Image" title="Image" style="-webkit-filter: invert(1);  filter: invert(1); outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 10%;max-width: 58px;" width="58">
  ...
  <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Mesa Verde Bank & Trust </span></p>
    </div>
  ...
  <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello, Mr. ${firstName} ${lastName}</span></p>
  <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
  <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">${text}</span></p>
    </div>
  ${modifiedContent}
        </td>
      </tr>
  ...
  <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">8500 Menaul Blvd, Albuquerque, New Mexico 87112</span></p>
